...
config.runtimeDataModel = JSON.parse('{"models":{"FiwareContextFile":{"fields":[{"name":"id","kind":"scalar","type":"Int"},{"name":"name","kind":"scalar","type":"String"},{"name":"file","kind":"scalar","type":"Json"},{"name":"createdAt","kind":"scalar","type":"DateTime"},{"name":"updatedAt","kind":"scalar","type":"DateTime"}],"dbName":null}},"enums":{},"types":{}}');
config.parameterizationSchema = {
  strings: JSON.parse('["where","FiwareContextFile.findUnique","FiwareContextFile.findUniqueOrThrow","orderBy","cursor","FiwareContextFile.findFirst","FiwareContextFile.findFirstOrThrow","FiwareContextFile.findMany","data","FiwareContextFile.createOne","FiwareContextFile.createMany","FiwareContextFile.createManyAndReturn","FiwareContextFile.updateOne","FiwareContextFile.updateMany","FiwareContextFile.updateManyAndReturn","create","update","FiwareContextFile.upsertOne","FiwareContextFile.deleteOne","FiwareContextFile.deleteMany","having","_count","_avg","_sum","_min","_max","FiwareContextFile.groupBy","FiwareContextFile.aggregate","AND","OR","NOT","id","name","file","createdAt","updatedAt","equals","in","notIn","lt","lte","gt","gte","not","string_contains","string_starts_with","string_ends_with","array_starts_with","array_ends_with","array_contains","contains","startsWith","endsWith","set","increment","decrement","multiply","divide"]'),
  graph: "-"
};
